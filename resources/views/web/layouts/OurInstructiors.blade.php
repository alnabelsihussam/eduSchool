            ...
            <div class="single-wrapper col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="team-single-item">
                    <figure>
                        <div class="member-img">
                            <div class="teachars_pro">
                                <img src="{{ asset('web/assets/images/team/team_4.jpg') }}" alt="member img"
                                    class="img-fluid">
                            </div>
                        </div>
                        <figcaption>
            ...
            <div class="single-wrapper col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="team-single-item">
                    <figure>
                        <div class="member-img">
                            <div class="teachars_pro">
                                <img src="{{ asset('web/assets/images/team/team_5.jpg') }}" alt="member img"
                                    class="img-fluid">
                            </div>
                        </div>
                        <figcaption>
            ...
            <div class="single-wrapper col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="team-single-item">
                    <figure>
                        <div class="member-img">
                            <div class="teachars_pro">
                                <img src="{{ asset('web/assets/images/team/team_6.jpg') }}" alt="member img"
                                    class="img-fluid">
                            </div>
                        </div>
                        <figcaption>
